...
<openmrs:require allPrivileges="Manage ATD" otherwise="/login.htm" redirect="/module/atd/updateFormConfig.form" />
<link
...
<html>
    <body>
        ...
        <form name="input" action="updateFormConfig.form" method="post" enctype="multipart/form-data">
        <table>
